  ...
  <v-app id="account">
    ...
    <v-main class="grey lighten-1 pt-4">
      <v-container>
        ...
        <v-row>
          <v-col cols="12" sm="8">
            <v-sheet min-height="60vh" rounded="lg" :elevation="10" dark>
              <v-container class="pa-10" fluid>
                <div>
                  <h1 class="text-center blue--text pa-2">
          ...
          <v-col cols="12" sm="4">
            <v-sheet rounded="lg" min-height="10vh" :elevation="10" dark>
              <v-container class="text-center black light-green--text">
                <h2>Shop Profile</h2>
              </v-container>
              <v-divider></v-divider>
                        ...
                        <v-card-text>
                          ...
                          <v-text-field
                            ...
                            :rules="[
                              ...
                              (v) =>
                                v.length <= 30 ||
                                'Owner Name must be less than 30 characters',
                              (v) =>
                                v.length >= 3 ||
                                'Owner Name must be greater than 3 characters',
                            ]"
                            required
                          ></v-text-field>
                          <v-text-field
                            ...
                            :rules="[
                              ...
                              (v) =>
                                v.length <= 100 ||
                                'Shop Address must be less than 100 characters',
                            ]"
                            required
                          ></v-text-field>
                          <v-text-field
                            ...
                            :rules="[
                              ...
                              (v) =>
                                v.length === 10 ||
                                'Shop Contact must be 10 digits',
                              (v) =>
                                /^[0-9]+$/.test(v) || 'Contact must be number',
                            ]"
                            required
                          ></v-text-field>
                          ...
                          <v-text-field
                            ...
                            :rules="[
                              (v) =>
                                v.length <= 15 ||
                                'Shop GSTIN must be less than 15 characters',
                            ]"
                            required="false"
                          ></v-text-field>
                        </v-card-text>
              ...
              <v-container class="text-center pa-7">
