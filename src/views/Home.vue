  ...
  <v-app id="home">
    <v-app-bar app color="grey darken-4" flat>
      <v-tabs centered color="white" dark>
        ...
        <v-tab router to="/about"> About </v-tab>
                ...
                <v-col>
                  <span>
                    ...
                    <body>
                      ...
                      physical paper and looking to digitalize your business. We
            ...
            <v-expansion-panels inset focusable>
              <v-expansion-panel>
                ...
                <v-expansion-panel-content>
                  ...
                  managing their business. This is a management system that will
                  help the merchant to keep track of their sales, inventory, and
                  other business related information. This system will also help
                  the merchant to manage their business in a more efficient way.
                  Keep all the record (sales, inventory, etc.) of your business
                  in one place and manage it online with ease.
                </v-expansion-panel-content>
              </v-expansion-panel>
              ...
              <v-expansion-panel>
                ...
                <v-expansion-panel-content>
                  ...
                  team of developers and we have to pay for the technology which
                  we are using to serve our customers like servers, domains,
                  databases etc. However, we provide limited free trial period
                  for our customers on special requests from their side, so that
                  they can try out our system and see if it is suitable for
                  them.
                </v-expansion-panel-content>
              </v-expansion-panel>
              ...
              <v-expansion-panel>
                ...
                <v-expansion-panel-content>
                  ...
                  other business related information online. If you want to keep
                  transactional records, sales, inventory, etc. of your business
                  in one place, then this is the technology that you need. We
                  provide all sorts of features to make your business management
                  easier, and many more features are coming soon.
                </v-expansion-panel-content>
              </v-expansion-panel>
            </v-expansion-panels>
          </v-row>
